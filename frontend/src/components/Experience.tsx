...
export default function Experience() {
  return (
    <div id="experience" className="max-w-7xl mx-auto px-4 py-16">
      ...
      <h2 id="work" className="text-4xl font-bold text-left mt-4 mb-8">
        Work Experience
      </h2>
      ...
      <h2
        id="projectSection"
        className="text-4xl font-bold text-left mt-16 mb-8"
      >
        Projects
      </h2>
      ...
      <div
        id="educationExperiences"
        className="border-t border-accent-500 pt-6"
      >
        {experiences
